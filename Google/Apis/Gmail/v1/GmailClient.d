module Google.Apis.Gmail.v1.GmailClient;
...
import Google.Apis.Gmail.v1.GmailScopes: Scopes, GmailScopes;
...
class GmailClient {
    ...
    private static const string ACCESS_TOKEN_FILE = "GmailAccessToken";

    /* Name of the file that stores the refresh token */
    private static const string REFRESH_TOKEN_FILE = "GmailRefreshToken";
    ...
    this(string credentialsFile, Scopes _scope) {
        ...
        this._scope = GmailScopes.all()[_scope];
    ...
    public GmailClient setScope(Scopes _scope) {
        this._scope = GmailScopes.all()[_scope];
        authorize();
        return this;
    }
